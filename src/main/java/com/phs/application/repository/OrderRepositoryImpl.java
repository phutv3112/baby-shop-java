...
public class OrderRepositoryImpl  {
    ...
    public List<OrderDetailResponse> getDetail(String billCode) {
        StringBuilder sql = new StringBuilder("select orders.id,receiver_address, receiver_name,product_id, receiver_phone, quantity, product.sale_price * orders.quantity as prices, bill_code , note, has_paid\n" +
                "from orders\n" +
